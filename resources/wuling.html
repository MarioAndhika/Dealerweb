...
<body>
    ...
    <div class="container my-5 main-content-box">
        <div class="row">
            ...
            <div class="specification-section">
                <h3 class="text-white">Daftar Harga Wuling Almaz-Hybrid</h3>
                <div class="price-box">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="card p-3 mb-3">
                                <h5 class="card-title">Edisi Almaz Hybrid</h5>
                                <p class="card-text">Harga Rp476 Juta</p>
                                <p class="card-text">Dedicated Hybrid Transmission, 7 seats, 1,999 cc, Bensin</p>
                            </div>
                        </div>
                        <div class="col-md-4">
             ...
             <div class="specification-section">
                <p>Wuling Almaz Hybrid adalah salah satu mobil SUV hybrid terbaru yang diluncurkan di Indonesia. Mobil ini merupakan hasil kolaborasi antara Wuling Motors dan SAIC General Motors (SGM) yang menawarkan teknologi ramah lingkungan serta performa yang handal.
                    Tampilan Luar dan Interior</p>
                <p>Wuling Almaz Hybrid memiliki desain yang sporty dan modern dengan lampu depan LED yang memperkuat tampilan agresifnya. Bagian depan mobil ini memiliki gril yang menonjol dengan logo Wuling yang besar di tengah. Sementara pada bagian belakangnya terdapat spoiler dengan lampu LED yang ramping serta stop lamp yang terintegrasi dengan spoiler tersebut.</p>
                <p>Pada bagian interiornya, Wuling Almaz Hybrid memiliki ruang yang luas dan nyaman untuk penumpangnya. Kabin mobil ini dilengkapi dengan berbagai fitur seperti AC otomatis, layar sentuh 10,4 inci yang dilengkapi dengan sistem hiburan, kamera belakang, kamera 360 derajat, dan fitur keselamatan seperti ABS, EBD, dan SRS Airbag.</p>    
                <p>Performa dan Teknologi Hibrida</p>
                <p>Wuling Almaz Hybrid dilengkapi dengan mesin bensin 1.5-liter turbocharged yang dipadukan dengan motor listrik. Kombinasi kedua mesin ini mampu menghasilkan tenaga sebesar 120 hp dengan torsi maksimum 168 Nm. Mesin ini dipadukan dengan transmisi otomatis CVT yang membuat perpindahan gigi lebih halus dan responsif.</p>
                <p>Teknologi hibrida pada Wuling Almaz Hybrid mampu menghemat bahan bakar hingga 10 persen dibandingkan dengan mobil SUV konvensional. Mobil ini juga dilengkapi dengan sistem regeneratif yang dapat mengubah energi kinetik saat pengereman menjadi energi listrik yang digunakan untuk mengisi baterai mobil.</p>
            </div>
                <div class="specification-section">
                    ...
                    <table class="table table-dark table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th>Detil Mesin</th>
                                <td>
                                    <p>Konfigurasi mesin: Naturaly Aspirated, Atkinson cycle</p>
                                    <p>Isi silinder (cc): 1999</p>
                            ...
                            <tr>
                                <th>Performa</th>
                                <td>
                                    <p>Tenaga: 120 hp/5600 rpm</p>
                                    <p>Torsi: 168Nm/4000-4,400 Rpm</p>
                                </td>
                            </tr>
                            <tr>
                                <th>Suspensi & Rem</th>
                                <td>
                                    ...
                                    <p>Suspensi Belakang: Torsion beam</p>
                                </td>
                            </tr>
                            <tr>
                                <th>Velg & Ban</th>
                                <td>
                                    ...
                                    <p>Material velg: 18 inch alloy</p>
                                </td>
                            </tr>
                            <tr>
